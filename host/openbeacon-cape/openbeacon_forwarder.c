...
#define PORT 2342
#define IP4_SIZE 4
#define REFRESH_SERVER_IP_TIME (60) /* was 60*5*/
...
uint32_t g_reader_ip;
uint64_t g_reader_mac;
...
*/
	...
	printf("Looking for a sink server ... ");
	while(getactivedatasink(host) == 0) printf("Waiting for server %s ...\r", host);
